################################################################
# This is a generated script to automate the vivado project for ELM board bring up tests.
# Initially it is designed for DDR-PS tests.
# functionality to be added-
# 					1. Create HW project in vivado version 2019.1 with elm specific device. open GUI(optional)
# 					2. Create IP block design with PS configuration as needed for DDR tests
#					3. Validate the design
#					4. Create HDL wrapper
#					5. Generate Output products (optional)
#					6. Export the design to SDK (optional)
################################################################
